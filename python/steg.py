...
class Steganography:
    ...
    def __init__(self, action='embed', message:str=None, password:str=None, method:str='LSB', image_file:str=None, message_file:str=None, output:str=None) -> None:
        ...
        self.__png = None
        self.__image_width, self.__image_height = None, None
        self.__pixel_count = None
        self.__rgb_count = None
        self.__image_pxs = None
    ...
    def __set_chunk_size(self):
        rgb_used = (self.__rgb_count) / (len(self.__binary_message) * 9)
    ...
    def __zigzag_change_pixels(self):
        ...
        for chunk_index, chunk in enumerate(chunked_message()):
            ...
            for loop in range(amount_of_pixels_to_hide_data):
                ...
                LSBs = tuple(str(px_value%2) for px_value in self.__image_pxs[x, y])
    ...
    def run(self):
        if self.__action == 'embed': self.embed_message()
        elif self.__action == 'extract': self.extract_message()
